...
<div class="mainnav">
	...
	<a id="logo" href="/">svelte-frontend</a>

	<div class="burger" class:change={navOpen} on:click="{toggleBurger}">
		<div class="bar1"></div>
		<div class="bar2"></div>
		<div class="bar3"></div>
	</div>
	...
	<div id="links">
	  <a href="/examples"><i class="fas fa-vial" style="margin-right:8px;"></i>Examples</a>
